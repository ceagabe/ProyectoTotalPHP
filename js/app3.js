...
function loadItems() {
  ...
  function deleteItem(id) 
  {
    ...
    fetch(`https://ceagabe.000webhostapp.com/api/api.php?id=${id}`, 
...
function updateItem(data) 
    {
        //fetch(`http://localhost/proyectofinal/api/api.php?id=${data.id}`, 
        fetch(`https://ceagabe.000webhostapp.com/api/api.php?id=${data.id}`, 
